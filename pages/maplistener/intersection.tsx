...
function createLightMarker(map: naver.maps.Map, itstId: string, latitude: number, longitude: number) : naver.maps.Marker {
...
function markerListener(map: naver.maps.Map, marker: naver.maps.Marker,  markers: Array<naver.maps.Marker>, itstNm: string) {
  if (interval !== null) {
    stopIntervals();
  }
...
export {getIntersectionFromJson, markerListener, stopIntervals, resetInfowindow, createLightMarker, infowindow};